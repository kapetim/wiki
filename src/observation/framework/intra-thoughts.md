...
```mermaid
flowchart LR
  standby[Standby — silence saves energy]
  line[Line of thought]
  sim[Simulate — podcast in the mind]
  decline[Decline the match]
  export[Export — speak out loud / AI]
  shred[Shred — file and move on]
  standby --> line --> sim
  sim -->|expensive| decline
  sim -->|useful| export
  export --> shred
```
