...
## 🕹️ Routine as the joystick

- The **daily routine** is the input device — the joystick providing player commands.
- Achievements are reached by **feeding the routine the right commands over time**, not by one heroic input.
- Without a target list, the joystick drifts — see [play § life dream](./play.md#-life-dream-and-rat-wheel).
