...
**What this is:** the frameworks, theories, and media reads — organised by lens. The guiding stance is that a **prejudice is a hypothesis**: a first label from partial signal, to be
**proved or dropped later** — see [perception/prejudice.md](perception/prejudice.md).
